...
extern uint8_t scale8(uint8_t i, fract8 scale);
extern uint16_t scale16by8(uint16_t i, fract8 scale);
extern uint16_t scale16(uint16_t i, fract16 scale);
extern uint8_t scale8_LEAVING_R1_DIRTY(uint8_t i, fract8 scale);
extern uint8_t blend8(uint8_t a, uint8_t b, uint8_t amountOfB);
// SIMU ADD CODE
//===================================================
